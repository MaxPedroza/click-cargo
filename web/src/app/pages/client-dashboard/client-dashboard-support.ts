...
@Component({
  selector: 'app-client-dashboard-support',
  standalone: true,
  ...
  template: `
    <section class="content">
      <header class="header">
        ...
        <p class="hint">
          Envie suas dúvidas sobre o uso da Click & Cargo como cliente. Nossa
          equipe retornará pelo e-mail informado.
        </p>
      </header>
      ...
      <form (ngSubmit)="submit()" novalidate>
        ...
        <div class="field-group">
          ...
          <select id="subject" [(ngModel)]="form.subject" name="subject">
            ...
            <option value="orcamentos">Dúvidas sobre orçamentos e pedidos</option>
            <option value="pagamentos">Pagamentos e comprovantes</option>
            <option value="vistoria">Vistoria virtual e serviços extras</option>
...
export class ClientDashboardSupportComponent {
  form = {
    name: '',
    email: '',
    phone: '',
  ...
  private validate(): boolean {
    ...
    if (!this.form.name.trim()) {
      messages.push('Informe o seu nome.');
    }
